...
![Slapukai](vz_slapukai.png "Slapukai")
...
2018-ais esu pranešęs per [NKSC](https://www.nksc.lt/) apie galimybe įterpti Stored XSS akivaizdžioje vietoje - VŽ komentaruose. (Vėliau pavyko surasti XSS komentaruose ir vėl. Bet apie tai [skaitykite čia](#xss-komentaruose-nr-1).) Pabandykime surasti XSS VŽ portale... Po kurio laiko išryškėja pirmasis kandidatas: [https://www.vz.lt/apps/pbcs.dll/exec?name=asdf](https://www.vz.lt/apps/pbcs.dll/exec?name=asdf).
...
![ERROR: Script italic_start asdf italic_end_ is missing!](vz_script_asdf_is_missing_italic.png "ERROR: Script italic_start asdf italic_end is missing!")
...
![Access denied](vz_access_denied.png "Access denied")
...
Kiek vėliau atsitiktinai atradau XSS VŽ komentaruose. Komentuojančio vartotojo vardas buvo tvarkingai atvaizduojamas net jei tas vardas turėjo specialių HTML simbolių kaip `Vardas<script>alert(1)</script>`. Tačiau jei į tokio vartotojo komentarą kas nors atsakydavo, jo vardas buvo interpretuojamas kaip HTML kodas. Taigi iš esmės užtektų tam pačiam vartotojui atsakyti į savo paties komentarą ir straipsnis su tokių komentaru butų "apkrėstas" kenkėjišku JavaScript kodų:  

![Stored XSS](vz_stored_xss1.png "Stored XSS")
...
Po pranešimo VŽ pataisė šią spragą, o taip pat pradėjo filtruoti vartojo vardus vartotojo profilio nustatymuose. Tačiau pastebėjau dar vieną šio XSS variaciją. Tuo metu kai nieko neįtariantis vartotojas tik paspausdavo "Atsakyti" į kenkėjiško vartotojo komentarą, jo vardas vis dar būdavo interpretuojamas kaip HTML:

![Stored XSS](vz_stored_xss2.png "Stored XSS")
...
2022.02.14 - NKSC pranešė, kad susisiekė su VŽ. Dėl neaiškių aplinkybių mano el. laiškas jų nepasiekė.  
...
2022.01.28 - NKSC pranešė, kad susiekė VŽ telefonu.  

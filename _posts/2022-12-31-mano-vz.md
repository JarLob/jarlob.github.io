...
2018-ais esu pranešęs per [NKSC](https://www.nksc.lt/) apie galimybe įterpti Stored XSS akivaizdžioje vietoje - VŽ komentaruose. (Vėliau pavyko surasti XSS komentaruose ir vėl. Bet apie [skaitykite čia](#xss-komentaruose).) Pabandykime surasti XSS VŽ portale... Po kurio laiko išryškėja pirmasis kandidatas: [https://www.vz.lt/apps/pbcs.dll/exec?name=asdf](https://www.vz.lt/apps/pbcs.dll/exec?name=asdf).
...
2022.03.09 - Išsiųstas el. laiškas apie Stored XSS VŽ komentaruose VŽ Interneto produktų vystymo skyriaus vadovui ir [NKSC](https://www.cert.lt).  
2022.01.28 - NKSC pranešė, kad susiekė VŽ telefonu.  
2022.03.09 - VŽ padėkojo ir pranešė, kad pažeidžamumas ištaisytas.  
